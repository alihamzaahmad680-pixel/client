...
export const Login = () => {
  // یہاں ہم نے گلوبل axios نکال لیا جو صحیح بیس یو آر ایل استعمال کرتا ہے
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      // ہارڈ کوڈڈ یو آر ایل ہٹا کر صرف اینڈ پوائنٹ لگا دیا
      const endpoint =
        state === "signup" ? "/api/user/register" : "/api/user/login";
